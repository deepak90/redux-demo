...
<Notes>
  <ul>
    ...
    <li>cool features like react has shadow dom and reusable components, VueJS does not need a steep learning curve, easy to use, Angular JS is turning from the disorganized dumpster fire that it was into a coherent framework</li>
    <li>But they've all got one thing in common - they've got to record, store and share and represent data based on user interaction</li>
